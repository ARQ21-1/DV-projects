...
//___________________________________________________________________________________________________________
  ...
  assign HSEL    = _if.HSEL;
  assign HADDR   = _if.HADDR;
  assign HWDATA  = _if.HWDATA;
  assign HWRITE  = _if.HWRITE;
  assign HSIZE   = _if.HSIZE;
  assign HBURST  = _if.HBURST;
  assign HPROT   = _if.HPROT;
  assign HTRANS  = _if.HTRANS;
  assign HREADY  = _if.HREADY;

  
  assign  _if.HRESP =     HRESP ;
  assign  _if.HRDATA =    HRDATA  ;
  assign  _if.HREADYOUT = HREADYOUT ;
  assign  _if.tint =      tint    ;
//___________________________________________________________________________________________________________
  //////////////////////////////////////////////////////////////////
  //
  // Constants
